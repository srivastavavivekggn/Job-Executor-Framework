...
public class JobRemotingUtil {
    ...
    public static ReturnT postBody(String url, String accessToken, int timeout, Object requestObj, Class returnTargClassOfT) {
        ...
        try {
            ...
            if (statusCode != 200) {
                return new ReturnT<String>(ReturnT.FAIL_CODE, "job remoting fail, StatusCode("+ statusCode +") invalid. for url : " + url);
            }
            ...
            try {
                ...
                logger.error("job remoting (url="+url+") response content invalid("+ resultJson +").", e);
                return new ReturnT<String>(ReturnT.FAIL_CODE, "job remoting (url="+url+") response content invalid("+ resultJson +").");
            }
